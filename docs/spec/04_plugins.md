...
*   **Behavior**: Validate inputs, apply modifications, write to temp file, atomic commit. All dataset plugins (CSV, Excel, Parquet) now use atomic write logic for safe concurrent editing.
